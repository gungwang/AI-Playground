...
:new: **AI Playground 3.2.1 (all SKUs)** - [Release Notes](https://github.com/intel/AI-Playground/releases) | [Download](https://github.com/intel/AI-Playground/releases/download/v3.2.1/AI-Playground-installer.exe) :new:
